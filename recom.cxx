...
void Recom::input_membership(int index){
  std::string file = "psn_game/membership/"+std::to_string(index)+".txt";
...
void Recom::input_data(){
  std::string filename = "psn_game/data/data.txt";
...
void Recom::input_users(){
  std::string filename = "psn_game/data/users.txt";
  std::string str;
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
...
void Recom::input_games(){
  std::string filename = "psn_game/data/games.txt";
  std::string str;
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
...
void Recom::input_games_url(){
  std::string filename = "psn_game/data/games_url.txt";
  std::string str;
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
...
void Recom::input_images(){
  std::string filename = "psn_game/data/images.txt";
  std::string str;
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
...
void Recom::input_average(){
  std::string filename = "psn_game/data/average.txt";
  double value;
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
...
void Recom::input_platform(){
  std::string filename = "psn_game/data/platform.txt";
  int value;
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
...
void Recom::input_count(){
  std::string filename = "psn_game/data/count.txt";
  int key;
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
...
void Recom::input_active_user(std::string actuser){
  std::string filename = "psn_game/data/"+actuser+".txt";
  std::ifstream ifs(filename);
  if(ifs.fail()){
    std::cerr << "can't find " << filename <<std::endl;
    std::exit(1);
